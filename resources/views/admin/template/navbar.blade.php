	<section class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class=""><a href="{{ route('admin.offer.index') }}"><i class='fa fa-handshake-o'></i> <span>Oferty</span></a></li>
			<li class=""><a href="{{ route('admin.logs') }}"><i class='fa fa-code'></i> <span>Logi</span></a></li>
