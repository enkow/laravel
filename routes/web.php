...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::rest('file', 'FileController', 'admin', ['index', 'create']);
        Route::get('/file/delete/{filename?}', ['as' => 'admin.file.delete', 'uses' => 'FileController@delete']);
...
Route::get('/upload/{size}/{image}', ['as' => 'img', 'uses' => 'WebController@images']);